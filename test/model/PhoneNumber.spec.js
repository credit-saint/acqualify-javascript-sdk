...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AcqualifyApiDocumentation.PhoneNumber();
  });
  ...
  describe('PhoneNumber', function() {
    it('should create an instance of PhoneNumber', function() {
      ...
      //var instane = new AcqualifyApiDocumentation.PhoneNumber();
      //expect(instance).to.be.a(AcqualifyApiDocumentation.PhoneNumber);
    });
